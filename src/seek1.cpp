...
int main(int argc, char* argv[]) {
    ...
    try {
        // 2. Inicializa o índice primário (B+ Tree)
        ...
        // 4. Verifica o resultado da busca no índice
        if (data_ptr != -1) { // -1 indica que a chave não foi encontrada
            ...
            if (!data_file) {
                throw std::runtime_error("ERRO: Nao foi possivel abrir o arquivo de dados " + data_file_path);
            }
        ...
        // 5. Exibe as métricas de acordo com a especificação do trabalho
